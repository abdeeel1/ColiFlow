...
const AddTravel = () => {
    ...
    const formSchema = z.object({
        ...
        carModel: z
            .string()
            .min(3, "le modele du voiture doit comporter plus de trois mots"),
        carId: z
            .string()
            .min(
                4,
                    ...
                    >
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            {step < 4 ? (
                                ...
                                <button
                                    type="submit"
                                    className="btn btn-ghost bg-green-700 border-green-700 px-8 text-[1rem] rounded-2xl hover:text-white text-white"
                                >
                                    {loading ? (
