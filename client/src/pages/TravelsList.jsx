...
import { ArrowRight, BadgeCheck, Calendar, Divide, Heart, MapPin, Package, Search, Star } from "lucide-react";
  ...
  return (
      <main>
        ...
        <div className="hidden lg:flex justify-center items-center bg-white rounded-full border border-gray-200 px-2.5 py-0 gap-1 max-w-4xl mx-auto mt-2 ">
          ...
          <div className="flex items-center gap-2 px-3 xl:px-4" style={{ flex: "0.9" }}>
            ...
            <div className="flex flex-col min-w-0 w-full">
              ...
              <input type="text"  placeholder="Fragile, alimentaire..."
                className="border-none outline-none bg-transparent text-xs xl:text-sm text-gray-800 placeholder-gray-300 py-0.5 w-full" />
            </div>
          </div>
        ...
        <div className="hidden lg:flex gap-2 items-center my-4">
          ...
          <div>
            <button className="px-4 py-[0.52rem] bg-white rounded-2xl font-bold text-sm text-[#757575] cursor-pointer">Urgence</button>
          </div>
          <div>
            <button className="px-4 py-[0.52rem] bg-white rounded-2xl font-bold text-sm text-[#757575] cursor-pointer">Verification</button>
          </div>
          <div>
            <DrawerRight />
          </div>
