...
const AddPackage = () => {
    ...
    const formSchema = z.object({
        colisName: z
            .string()
            .trim()
            .min(2, "le nom du colis doit comporter plus de trois mots"),
        category: z
            .string()
            .min(1, "la sélection d'une catégorie est obligatoire"),
        ...
        price: z.coerce
            ...
            .min(1, "Prix requis"),
        acceptCondition: z.literal(
            true,
            "vous devez accepter pour publier votre annonce",
        ),
    })
    ...
    const nextStep = async () => {
        ...
        if (step === 2)
            fields = ["cityOne", "cityTwo", "dateDelivery", "emergencies"]
            ...
            <div className="max-w-5xl mx-auto flex flex-col gap-6">
                ...
                <div className="bg-[#0984E3] rounded-[2rem] p-6 md:p-8 shadow-lg shadow-blue-500/20">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="md:hidden flex flex-col">
                            ...
                            <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                                <div
                                    className="bg-[#0984E3] h-full transition-all duration-500 ease-out rounded-full"
                    ...
                    <p className="pt-6 text-blue-50/90 font-medium text-sm md:text-base">
                        Complétez les 4 étapes pour proposer votre colis à la
                        communauté.
                    </p>
                </div>
                        ...
                        <div className="flex justify-between mt-6">
                            {step > 1 && (
                                <button
                                    type="button"
                                    onClick={prevStep}
                                    className="btn btn-ghsot bg-neutral-500 border-neutral-500 px-8 text-[1rem] rounded-2xl text-white font-bold"
                                >
                                    Prev
                                </button>
                            )}
                            ...
                            {step < 4 ? (
                                <button
                                    type="button"
                                    onClick={nextStep}
                                    className="btn btn-ghost px-8 text-[1rem] bg-[#0984E3] border-[#0984E3] rounded-2xl text-white font-bold"
                                >
                                    Next
                                </button>
                            ) : (
                                <button
                                    type="submit"
                                    className="btn btn-ghost bg-green-700 border-green-700 px-8 text-[1rem] rounded-2xl text-white"
                                >
                                    {loading ? (
