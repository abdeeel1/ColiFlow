    ...
    const travelsAnnouncement = [
        {
            ...
            description:
                "Je fais le trajet direct par l'autoroute. Je peux récupérer le colis près de Moulay Abdellah. Pas de liquides,  Pas de produits fragiles sans emballage, Remise en main propre",
            point: "Stade D'honor",
            ville_depart: "fez",
            ville_darrive: "rabat",
            date: "demain 9:00",
            ...
            review: 120,
            images: [
                "/vehicles/Dacia-Duster-1.webp",
                "/vehicles/Dacia-Duster-2.webp",
                "/vehicles/Dacia-Duster-3.webp",
            ],
        },
        {
            id: 2,
            ...
            review: 100,
            images: [
                "/vehicles/Kia-Picanto-1.webp",
                "/vehicles/Kia-Picanto-2.webp",
                "/vehicles/Kia-Picanto-3.webp",
            ],
        },
        {
            id: 3,
        ...
        <main>
            <div className="flex relative w-full h-full xl:h-204 shadow-2xl rounded-2xl ">
                <div className="hidden xl:block">
                    ...
                    <img
                        src={travel.images[selectedImage]}
                        alt=""
                                ...
                                {travel.images.map((image, index) => (
                                    <div className="" key={index}>
                                        <img
                                            src={image}
                                            alt=""
                                            className={`w-full h-15 rounded-2xl ${selectedImage === index ? "border-3 border-[#46c48f]" : "border-transparent "}`}
                                            onClick={() => {
