    ...
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
        <div className="bg-gray-800 border border-transparent dark:border-gray-700/60 text-gray-50 text-sm p-3 md:rounded-sm shadow-lg flex justify-between">
          <div className='text-gray-500 flex gap-1'><span className="font-medium hover:underline text-gray-50" href={liteLink} target="_blank" rel="noreferrer">Besoin d'aide sur l'application?</span><Link to={"/readmore/Customer Support"} className="font-medium hover:underline text-[#6abbf8] " href="" target="_blank" rel="noreferrer" > Consulter le Guide ColiFlow</Link></div>
