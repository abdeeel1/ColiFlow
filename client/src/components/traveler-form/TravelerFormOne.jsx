        ...
        <div className="bg-white shadow-sm border border-slate-100 p-6 md:p-8 rounded-[2rem]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="relative w-full">
                        <select
                            {...register("travelCityOne")}
                            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-[0.95rem] rounded-xl appearance-none px-4 py-3 focus:bg-white focus:outline-none focus:border-[#0984E3] focus:ring-4 focus:ring-[#0984E3]/10 transition-all cursor-pointer"
                        >
                    ...
                    {errors.travelCityOne && (
                        <p className="text-red-600 text-sm">
                            {errors.travelCityOne.message}
                        </p>
                    )}
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    {errors.travelCityTwo && (
                        <p className="text-red-600 text-sm">
                            {errors.travelCityTwo.message}
                        </p>
                    )}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 my-5">
                ...
                {errors.travelDescription && (
                    <p className="text-red-600 text-sm">
                        {errors.travelDescription.message}
                    </p>
                )}
            </div>
        </div>
