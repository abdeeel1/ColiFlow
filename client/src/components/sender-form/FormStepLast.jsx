            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-3 w-full md:w-1/2">
                    <label className="text-sm text-slate-700 font-bold">
                        Combien proposez-vous au voyageur ?
                    </label>
                ...
                <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex gap-3 items-center">
                    <div className=" md:mt-0 shrink-0">
                        <input
                            ...
                            className="w-6 h-6 checkbox checkbox-warning rounded-full"
                        />
                    </div>
                    <p className="text-sm font-medium text-orange-800 leading-tight">
                        Je confirme que le contenu de mon colis est conforme aux
                        lois en vigueur et ne contient aucune substance
                        interdite ou dangereuse.
                    </p>
                </div>
                {errors.acceptCondition && (
                    <p className="text-red-600 text-sm">
                        {errors.acceptCondition.message}
                    </p>
                )}
            </div>
        </div>
