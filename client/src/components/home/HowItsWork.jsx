...
const HowItsWork = () => {
    ...
    const voyageurData = [
        ...
        },
        {
            id: 3,
            etape: "étape 3",
            title: "Rentabilisez votre déplacement",
            description:
        ...
        <section className="py-20 2xl:py-20">
            <div>
                ...
                <p className="text-center py-5 font-semibold leading-relaxed text-lg text-[#1E293B]">
                    Que vous souhaitiez envoyer un colis en toute sécurité ou
                    rentabiliser votre trajet à travers le Maroc, ColiFlow vous
                    simplifie la vie.
                </p>
