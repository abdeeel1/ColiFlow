...
const HowItsWork = () => {
    ...
    const expediteurData = [
        {id: 1, etape: "étape 1", title : "Préparez votre envoi", description : "Indiquez le type de colis, son poids et sa destination. Fixez votre propre prix ou laissez les voyageurs proposer", feutures : ["Formulaire simple", "Flexibilité totale", "Photos illimitées"], picture: "/Etape-1.png"},
        {id: 2, etape: "étape 2", title : "Choisissez un voyageur", description : "Parcourez les profils vérifiés sur votre trajet. Consultez les avis et chattez directement avec eux pour fixer les détails", feutures : ["Profils vérifiés (CIN)", "Chat sécurisé intégré", "Offline support"], picture: "/Etape-2.png"},
        {id: 3, etape: "étape 3", title : "Envoi sécurisé", description : "Remettez votre colis en toute confiance. Le paiement reste bloqué en sécurité jusqu'à la confirmation de livraison", feutures : ["Paiement sécurisé", "Suivi en temps réel", "Support ColiFlow 24/7"], picture: "/Etape-3.png"},
    ]
    
    const voyageurData = [
        {id: 1, etape: "étape 1", title : "Publiez votre trajet", description : "Renseignez votre ville de départ, votre destination et la date de votre voyage. Précisez l'espace disponible dont vous disposez (sac à dos, coffre, etc...)", feutures : ["Saisie rapide des villes", "Gestion du calendrier", "Choix du mode de transport"], picture: "/Travel-Etape-1.png"},
        {id: 2, etape: "étape 2", title : "Recevez des propositions", description : "Parcourez les demandes d'envoi sur votre trajet ou recevez des notifications directes d'expéditeurs intéressés par votre itinéraire", feutures : ["Notifications en temps réel", "Chat sécurisé intégré", "Liberté d'acceptation"], picture: "/Travel-Etape-2.png"},
