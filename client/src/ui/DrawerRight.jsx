...
export default function DrawerRight() {
    return (
        <Drawer>
            <Button className="bg-white font-bold flex items-center gap-2 text-[#757575]">
                Filter <ListFilter className="size-[0.8rem]" />
            </Button>
            <Drawer.Backdrop>
                    ...
                    <Drawer.Dialog>
                        <Drawer.Body className="text-black py-5">
                            <div>
                                <div className="flex flex-col gap-4 pb-10">
                                    <p className="text-[0.8rem] lg:text-[1.2rem] font-semibold">
                                        Taille du Colis
                                    </p>
                                    <div>
                                        <CheckboxGroupSelect />
                        ...
                        <Drawer.Footer>
                            ...
                            <Button
                                slot="close"
                                variant="ghost"
                                className="bg-[#0984E3] text-white font-bold"
                            >
                                Sauvegarder
                            </Button>
                        </Drawer.Footer>
