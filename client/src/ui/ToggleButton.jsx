...
const ToggleButton = ({isTraveler, setIsTraveler}) => {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      className="relative w-24 h-6 bg-gray-200 rounded-full p-1 cursor-pointer 
      flex items-center shadow-inner transition-all duration-300">
        
        <div className={`absolute w-1/2 h-6 bg-[#0984E3] rounded-full shadow-md transition-transform duration-300 ease-in-out ${
