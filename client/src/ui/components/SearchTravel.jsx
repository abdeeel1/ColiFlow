...
const SearchTravel = () => {
  ...
  return (
    <div className="mt-10 bg-gray-100 flex items-center justify-center px-3">
      ...
      <form onSubmit={handleSubmit(onSubmitData)} className="flex flex-col lg:hidden bg-white rounded-2xl border border-gray-200 w-full max-w-md overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100">
          ...
          <div className="flex flex-col w-full">
            ...
            <input {...register('depart')} type="text"  placeholder="Ville de départ"
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100">
          ...
          <div className="flex flex-col w-full">
            ...
            <input {...register('arrive')} type="text" placeholder="Ville d'arrivée"
              className="border-none outline-none bg-transparent text-sm text-gray-800 placeholder-gray-300" />
          </div>
        </div>
        ...
        <div className="flex gap-0">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-r border-gray-100 flex-1">
            ...
            <div className="flex flex-col w-full">
              ...
              <input {...register('dateDepart')} type="date"
      ...
      {/* lg+: single pill row */}
      <form onSubmit={handleSubmit(onSubmitData)} className="hidden lg:flex items-center bg-white rounded-full border border-gray-200 px-2 py-1.5 gap-1 w-full max-w-3xl xl:max-w-4xl">
        ...
        <button type="submit" className="bg-[#0984E3] hover:bg-[#085fa1] active:scale-95 text-white text-xs xl:text-sm font-semibold px-4 xl:px-5 py-2 xl:py-2.5 rounded-full shrink-0 transition-all">
            <Search />
        </button>
