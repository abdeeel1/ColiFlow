                            ...
                            <div className="text-black p-4">
                                <div className="flex justify-between items-center">
                                    <p className="flex flex-col w-20  items-center">
                                        <span className="capitalize text-center font-semibold text-lg">{travel.ville_depart}</span>
                                    ...
                                    <p className="flex flex-col w-20  items-center">
                                        <span className="capitalize text-center font-semibold text-lg">{travel.ville_darrive}</span>
                                ...
                                <div className="flex  flex-col gap-4 pt-3 text-black capitalize">
                                    <div className="flex gap-4">
                                        ...
                                        <div className="bg-gray-100 capitalize rounded-[1rem] shadow p-3 w-full">
                                            ...
                                            <span className="font-semibold">{travel.type_veh}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div className="bg-gray-100 capitalize rounded-[1rem] shadow p-3 w-full">
                                            <p className="text-gray-600">Poids Max</p>
                                            <span className="font-semibold">{travel.poids}</span>
                                        </div>
                                        
                                        <div className="bg-gray-100 capitalize rounded-[1rem] shadow p-3 w-full">
                                            <p className="text-gray-600">Type de trajet</p>
                                            <span className="font-semibold">{travel.date}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center mt-5">
                                    ...
                                    <span className=""><span className="text-[1.5rem] font-bold text-[#374151]">{travel.price}</span> MAD</span>
                                </div>
